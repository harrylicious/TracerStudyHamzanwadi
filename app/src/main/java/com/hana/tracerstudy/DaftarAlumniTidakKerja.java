...
public class DaftarAlumniTidakKerja extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    private static final String URL = "https://tracerstudy.ti.ftuhamzanwadi.ac.id/get_alumni_status_kerja.php?key=0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_alumni_tidak_kerja);
